[![Build Status](https://github.com/opspec-pkgs/fs.mkdir/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/fs.mkdir/actions?query=workflow%3Abuild+branch%3Amain)
